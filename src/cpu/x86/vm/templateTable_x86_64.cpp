...
void TemplateTable::iastore() {
  ...
  oopDesc::bs()->compile_resolve_oop_for_write(_masm, rdx, true, 2, BarrierSet::ss_rax, BarrierSet::ss_rbx);
...
void TemplateTable::fastore() {
  ...
  // rdx:  array
  index_check(rdx, rbx); // prefer index in ebx
  oopDesc::bs()->compile_resolve_oop_for_write(_masm, rdx, true, 2, BarrierSet::ss_ftos, BarrierSet::ss_rbx);
...
void TemplateTable::dastore() {
  ...
  // rdx:  array
  index_check(rdx, rbx); // prefer index in ebx
  oopDesc::bs()->compile_resolve_oop_for_write(_masm, rdx, true, 2, BarrierSet::ss_dtos, BarrierSet::ss_rbx);
...
void TemplateTable::aastore() {
  ...
  oopDesc::bs()->compile_resolve_oop_for_write(_masm, rdx, true, 2, BarrierSet::ss_rax, BarrierSet::ss_rcx);
...
void TemplateTable::putfield_or_static(int byte_no, bool is_static) {
  ...
  // btos
  {
    ...
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, obj, true, 3, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx);
    __ movb(field, rax);
    if (!is_static) {
  ...
  // ftos
  {
    __ pop(ftos);
    if (!is_static) pop_and_check_object(obj);
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, obj, true, 4, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx, BarrierSet::ss_ftos);
  ...
  // dtos
  {
    __ pop(dtos);
    if (!is_static) pop_and_check_object(obj);
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, obj, true, 4, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx, BarrierSet::ss_dtos);
...
void TemplateTable::fast_storefield(TosState state) {
  ...
  switch (bytecode()) {
  case Bytecodes::_fast_aputfield:
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, rcx, true, 3, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx);
    do_oop_store(_masm, field, rax, _bs->kind(), false);
    break;
  case Bytecodes::_fast_lputfield:
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, rcx, true, 3, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx);
    ...
    break;
  case Bytecodes::_fast_iputfield:
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, rcx, 3, true, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx);
    __ movl(field, rax);
    break;
  case Bytecodes::_fast_bputfield:
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, rcx, 3, true, BarrierSet::ss_rax, BarrierSet::ss_rbx, BarrierSet::ss_rdx);
  ...
  case Bytecodes::_fast_cputfield:
    ...
    break;
  case Bytecodes::_fast_fputfield:
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, rcx, 3, true, BarrierSet::ss_rbx, BarrierSet::ss_rdx, BarrierSet::ss_ftos);
    __ movflt(field, xmm0);
    break;
  case Bytecodes::_fast_dputfield:
    oopDesc::bs()->compile_resolve_oop_for_write(_masm, rcx, 3, true, BarrierSet::ss_rbx, BarrierSet::ss_rdx, BarrierSet::ss_dtos);
    __ movdbl(field, xmm0);
    break;
  default:
    ShouldNotReachHere();
...
void TemplateTable::monitorenter() {
  ...
  oopDesc::bs()->compile_resolve_oop_for_write(_masm, rax, true);
